...
function computeRHS!(_model::Model, _RHS::Vector{Float64}, _axis::Int64, _fe::Vector{Float64}, _k::Matrix{Float64}, _g::Matrix{Float64}, _p::Matrix{Float64})
    # Initializations
...
function femEffective(_model::Model, _X::Vector{Float64}, _axis::Int64, _SN::Matrix{Float64})
