...
def flow_view(FILE_PATH):
    ...
    print(num_pixels)
    # reading lines
    flow_x_rhs_0 = open("pyview/values/flow_x_rhs_0.txt", "r")
    flow_y_rhs_0 = open("pyview/values/flow_y_rhs_0.txt", "r")
    flow_x_rhs_1 = open("pyview/values/flow_x_rhs_1.txt", "r")
    flow_y_rhs_1 = open("pyview/values/flow_y_rhs_1.txt", "r")
    ...
    plt.savefig("pyview/images/flow_rhs_0.png")
    ...
    ax.quiver(x_pos, y_pos, x_direction, y_direction)
    ax.set_title('Flow field')
    plt.savefig("pyview/images/flow_rhs_1.png")
